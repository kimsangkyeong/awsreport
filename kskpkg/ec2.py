            ...
            if len(rsv["Instances"]) > 0 :
              for ins in rsv["Instances"]:
                ...
                results.append( { "InstanceId": ins["InstanceId"],
                                  ...
                                  "KeyName" : keyname,
                                  "PrivateIpAddress" : ins["PrivateIpAddress"] if 'PrivateIpAddress' in ins else ' ',
                                  ...
                                  "ENITName" : ' ',
                                  "NetworkInterfaceId" : netinfids,
                                  "SubnetId" : ins["SubnetId"] if 'SubnetId' in ins else ' ',
                                  "SubnetTName" : '',
                                  "VpcId" : ins["VpcId"] if 'VpcId' in ins else ' ',
                                  "VpcTName" : '',
